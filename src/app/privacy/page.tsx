      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <p className="mb-3 leading-relaxed">当ウェブサイトでは、以下の個人情報を収集する場合があります：</p>
            ...
            <p className="mb-3 leading-relaxed">収集した個人情報は以下の目的で利用します：</p>
            <ul className="list-disc list-inside mb-4 ml-4 space-y-2">
              <li>お問い合わせへの回答・対応</li>
            ...
            <p className="mb-3 leading-relaxed">当チームは、以下の場合を除き、個人情報を第三者に提供しません：</p>
            <ul className="list-disc list-inside mb-4 ml-4 space-y-2">
              <li>ご本人の同意を得た場合</li>
              <li>法令に基づく場合</li>
            ...
            <p className="mb-3 leading-relaxed">個人情報は利用目的の達成に必要な期間のみ保存し、以下を基準とします：</p>
            <ul className="list-disc list-inside mb-4 ml-4 space-y-2">
              <li>お問い合わせ情報：2年間</li>
            ...
            <p className="mb-3 leading-relaxed">個人情報の開示、訂正、利用停止等に関するお問い合わせは、以下までご連絡ください：</p>
            <ul className="list-disc list-inside mb-4 ml-4 space-y-2">
